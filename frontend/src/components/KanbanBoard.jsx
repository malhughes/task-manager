  ...
  const handleTaskMove = useCallback(
    async (taskId, newStatus) => {
      ...
      try {
        ...
        showError(`Failed to move "${taskToMove.title}": ${errorMessage}`, {
          title: "Move Failed",
          action: (
            <Button
              size="small"
        ...
        {!navigator.onLine && (
          <Alert severity="warning" sx={{ mt: 2 }}>
            ...
            <Typography variant="body2">
              Please check your internet connection and try again. Your tasks
              will be available once you're back online.
            </Typography>
          </Alert>
        )}
    ...
    >
      ...
      <Box
        sx={{
          ...
          gap: isMobile ? 1.5 : 2,
          height: isMobile ? "auto" : "calc(100vh - 204px)",
          maxHeight: isMobile ? "calc(100vh - 120px)" : "calc(100vh - 204px)",
